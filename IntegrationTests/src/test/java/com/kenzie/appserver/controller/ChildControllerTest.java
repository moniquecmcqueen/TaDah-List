...
@IntegrationTest
    public class ChildControllerTest {
        ...
        public void getChildByIdTest_NoId() {
            ...
            when(childService.findById(noChildId)).thenReturn(null);

            ResponseEntity<Child> nullResponse = childController.getChildById(noChildId);

            Assertions.assertEquals(HttpStatus.NOT_FOUND,nullResponse.getStatusCode());
            Assertions.assertEquals(null,nullResponse.getBody());
            verify(childService,times(1)).findById(noChildId);
    ...
    public void checkUsernameTest_NonExistingName(){
            ...
            when(childService.findByUsername(doesntExist)).thenReturn(null);
            ...
            verify(childService, times(1)).findByUsername(doesntExist);
